...
int coilStartIndex = 137; // ตั้งค่าตามบอร์ด: 0, 5, 10, ...
...
// Wi-Fi
const char* ssid = "ESP32_3";
const char* password = "12345678";
WiFiClient client;
const char* receiverIP = "192.168.1.1";   // IP ของ ESP32 Receiver
const uint16_t receiverPort = 81;        // Port ที่ Receiver เปิดไว้


IPAddress local_IP(192, 168, 1, 15); // Your desired static IP
IPAddress gateway(192, 168, 1, 254);    // Your router's IP address
